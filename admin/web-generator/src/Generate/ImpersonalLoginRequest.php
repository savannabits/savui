...
class ImpersonalLoginRequest extends ClassGenerator {
     ...
     * @var string
     */
    protected $name = 'web:generate:request:impersonal-login';
    ...
    protected function buildClass() {
        ...
        return view('savannabits/web-generator::templates.admin-user.impersonal-login-request', [
    ...
    {
        return $rootNamespace.'\Http\Requests\Web\\'.$this->modelWithNamespaceFromDefault;
    }
