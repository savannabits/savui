...
class Permissions extends ClassGenerator {
     ...
     * @var string
     */
    protected $name = 'web:generate:permissions';
    ...
    protected function generateClass($force = false) {
        $fileName = 'fill_web_permissions_for_'.$this->modelRouteAndViewName.'.php';
    ...
    public function generateClassNameFromTable($tableName) {
        return 'FillWebPermissionsFor'.$this->modelBaseName;
    }
}
