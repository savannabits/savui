    ...
    public function __construct()
    {
        ...
        $this->users = [
            [
                ...
                'username' => env('INIT_ADMIN_USERNAME','smaosa'),
                'email' => env('INIT_ADMIN_EMAIL','smaosa@strathmore.edu'),
                'password' => Hash::make(env('INIT_ADMIN_PASS', $this->password)),
                'remember_token' => null,
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now(),
                'activated' => true,
